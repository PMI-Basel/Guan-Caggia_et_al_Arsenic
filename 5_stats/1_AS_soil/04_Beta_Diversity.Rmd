...
#score from PERMANOVA
score <- paste("[ ~ Arsenic * Timepoint: ",
               format(all_dist_paov$R2[rownames(all_dist_paov)=="Arsenic:Timepoint"] * 100, digits=2, nsmall=1),
               "% of variance, P = ",
               format(all_dist_paov$`Pr(>F)`[rownames(all_dist_paov)=="Arsenic:Timepoint"], digits=2),
               "]", sep = "")
